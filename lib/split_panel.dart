library makery_ui_split_panel.split_panel;
...
class SplitPanelElement extends PolymerElement {
  ...
  void _createSplitBars() {
    ...
    for (int i = 0; i < childPanels.length - 1; i++) {
      ...
      var bar = new Element.tag('split-bar-element') as SplitBarElement;
      bar..parent = this
  ...
  /**
   * Enables/Disables text selection inside this [SplitPanelElement].
   */
  void userSelectEnabled(bool enabled) {
    if (enabled) {
